...
const DRILL_DATA = {
  title: "Principle Violation Detector",
  prompt: "\"My opinion is worth more because I have more experience.\"",
  question: "Which logical fallacy does this statement commit?",
  options: [
    { id: "a", text: "Ad hominem", isCorrect: false },
    { id: "b", text: "Argument from authority", isCorrect: true },
    { id: "c", text: "Strawman", isCorrect: false },
    { id: "d", text: "False dilemma", isCorrect: false },
  ],
  explanation: "This is an argument from authority fallacy. Experience doesn't automatically make an opinion correct — the argument's validity depends on its logic and evidence, not the speaker's credentials."
};

export function PrincipleViolationDetector({ onComplete }: Props) {
