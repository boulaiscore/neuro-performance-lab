...
const DRILL_DATA = {
  title: "Socratic Differentiation Test",
  prompt: "\"Competitors are growing because they produce more content.\"",
  question: "Which statement does NOT logically follow from this claim?",
  options: [
    { id: "a", text: "If they stop producing content, growth will decline", isCorrect: false },
    { id: "b", text: "More content is the main cause of their growth", isCorrect: false },
    { id: "c", text: "Product quality has no influence on their growth", isCorrect: true },
    { id: "d", text: "More content creates more customer touchpoints", isCorrect: false },
  ],
  explanation: "Option C is not implied by the original claim. Saying content drives growth doesn't mean other factors (like product quality) are irrelevant — that's an unjustified logical leap."
};

export function SocraticDifferentiationTest({ onComplete }: Props) {
