...
const DRILL_DATA = {
  title: "Conceptual Coherence Test",
  prompt: "\"A decision-making model is valid even if it doesn't produce better outcomes.\"",
  question: "What is the fundamental problem with this statement?",
  options: [
    { id: "a", text: "A valid decision model must improve decision quality", isCorrect: true },
    { id: "b", text: "A model can be valid even if imperfect", isCorrect: false },
    { id: "c", text: "Models are for understanding, not deciding", isCorrect: false },
    { id: "d", text: "Validity can be purely theoretical", isCorrect: false },
  ],
  explanation: "There's a conceptual contradiction: a decision-making model's purpose is to improve decisions. If it doesn't, it fails its core function and cannot be called 'valid' as a decision model."
};

export function ConceptualCoherenceTest({ onComplete }: Props) {
