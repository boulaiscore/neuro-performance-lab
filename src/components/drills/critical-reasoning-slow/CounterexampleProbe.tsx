...
const DRILL_DATA = {
  title: "Counterexample Probe",
  prompt: "\"A decision made quickly is always less accurate than a slow decision.\"",
  question: "Which example best disproves this claim?",
  options: [
    { id: "a", text: "A surgeon recognizing a hemorrhage in 1 second", isCorrect: true },
    { id: "b", text: "A startup that pivots poorly and quickly", isCorrect: false },
    { id: "c", text: "An impulsive purchase that turned out wrong", isCorrect: false },
    { id: "d", text: "A slow, revised plan that succeeded", isCorrect: false },
  ],
  explanation: "The surgeon's instant recognition can be more accurate than deliberation — a perfect counterexample showing fast decisions can outperform slow ones in expert domains."
};

export function CounterexampleProbe({ onComplete }: Props) {
