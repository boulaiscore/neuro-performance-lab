...
const DRILL_DATA = {
  title: "Hidden Assumption Detector",
  prompt: "\"Productivity is low because the team isn't motivated enough.\"",
  question: "What hidden assumption does this statement rely on?",
  options: [
    { id: "a", text: "Motivation is the main driver of productivity", isCorrect: true },
    { id: "b", text: "The team lacks adequate skills", isCorrect: false },
    { id: "c", text: "Processes are inefficient", isCorrect: false },
    { id: "d", text: "Resources are insufficient", isCorrect: false },
  ],
  explanation: "The conclusion assumes motivation is the primary cause of productivity. This hidden assumption must be true for the argument to hold — but it may not be."
};

export function HiddenAssumptionDetector({ onComplete }: Props) {
