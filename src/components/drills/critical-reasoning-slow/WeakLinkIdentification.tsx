...
const DRILL_DATA = {
  title: "Weak Link Identification",
  prompt: "\"The project failed; therefore the team is incompetent.\"",
  question: "What is the main weakness in this reasoning?",
  options: [
    { id: "a", text: "There could be external causes for the failure", isCorrect: true },
    { id: "b", text: "The team didn't have enough budget", isCorrect: false },
    { id: "c", text: "There wasn't enough time", isCorrect: false },
    { id: "d", text: "The market wasn't ready", isCorrect: false },
  ],
  explanation: "The main weakness is ignoring alternative explanations. The argument jumps from 'project failed' to 'team is incompetent' without considering other possible causes."
};

export function WeakLinkIdentification({ onComplete }: Props) {
