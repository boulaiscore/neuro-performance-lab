...
const DRILL_DATA = {
  title: "Necessary Condition Finder",
  prompt: "\"This product will fail because it's too innovative.\"",
  question: "What necessary condition must be true for this argument to hold?",
  options: [
    { id: "a", text: "Users reject what is too new or unfamiliar", isCorrect: true },
    { id: "b", text: "The product has technical bugs", isCorrect: false },
    { id: "c", text: "Competition is too strong", isCorrect: false },
    { id: "d", text: "Marketing is weak", isCorrect: false },
  ],
  explanation: "The argument needs the assumption that users reject extreme novelty. Without this condition, 'too innovative' wouldn't cause failure."
};

export function NecessaryConditionFinder({ onComplete }: Props) {
