...
const DRILL_DATA = {
  title: "Socratic Reversal Test",
  prompt: "\"To succeed, you need to work more hours than others.\"",
  question: "Which statement best challenges this claim through logical inversion?",
  options: [
    { id: "a", text: "Working less but more deliberately can lead to greater success", isCorrect: true },
    { id: "b", text: "Success doesn't depend on anything", isCorrect: false },
    { id: "c", text: "Everyone who succeeds works fewer hours", isCorrect: false },
    { id: "d", text: "Success is purely luck", isCorrect: false },
  ],
  explanation: "Option A is the strongest logical inversion — it directly challenges the causal claim by showing the opposite approach can yield the same or better outcome."
};

export function SocraticReversalTest({ onComplete }: Props) {
