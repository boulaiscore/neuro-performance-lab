...
const DRILL_DATA = {
  title: "The Inferential Leverage Test",
  prompt: "Attention should go to the variable with the strongest causal link to the objective.",
  question: "Which detail gives you the most inferential leverage (i.e., unlocks the greatest understanding)?",
  options: [
    { id: "a", text: "Raw impressions from a meeting.", isCorrect: false },
    { id: "b", text: "A specific metric tied to the core objective.", isCorrect: true },
    { id: "c", text: "A historical anecdote from a colleague.", isCorrect: false },
    { id: "d", text: "A random variance spike unconnected to outcomes.", isCorrect: false },
  ],
  explanation: "Attention should go to the variable with the strongest causal link to the objective."
};

export function InferentialLeverage({ onComplete }: Props) {
