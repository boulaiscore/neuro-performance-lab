...
const DRILL_DATA = {
  title: "The Alternative Explanation Filter",
  prompt: "Socratic inquiry seeks to collapse the hypothesis space.",
  question: "Which fact rules out the largest number of alternative explanations?",
  options: [
    { id: "a", text: "A vague observation about user sentiment.", isCorrect: false },
    { id: "b", text: "A hypothesis proposed without evidence.", isCorrect: false },
    { id: "c", text: "A controlled experimental result.", isCorrect: true },
    { id: "d", text: "A senior manager's opinion.", isCorrect: false },
  ],
  explanation: "A controlled result collapses the hypothesis space—making it the most deserving of attention."
};

export function AlternativeExplanation({ onComplete }: Props) {
