...
const DRILL_DATA = {
  title: "The Principle of Sufficient Attention",
  prompt: "You must decide which detail deserves focus.",
  question: "Which of these, if true, explains the others?",
  options: [
    { id: "a", text: "The team is behind schedule.", isCorrect: false },
    { id: "b", text: "Tasks were never clearly defined.", isCorrect: true },
    { id: "c", text: "People are stressed.", isCorrect: false },
    { id: "d", text: "Meetings doubled in frequency.", isCorrect: false },
  ],
  explanation: "A premise that explains other premises is epistemically prior. System-2 attention must go to the cause that generates the other observations, not the symptoms."
};

export function SufficientAttention({ onComplete }: Props) {
