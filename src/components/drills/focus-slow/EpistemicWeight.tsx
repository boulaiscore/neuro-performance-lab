...
const DRILL_DATA = {
  title: "The Epistemic Weight Question",
  prompt: "Socratic criteria: independent verification + causal relevance.",
  question: "Which detail has the highest epistemic weight?",
  options: [
    { id: "a", text: "A founder's intuition.", isCorrect: false },
    { id: "b", text: "A single customer anecdote.", isCorrect: false },
    { id: "c", text: "A consistent multi-week trend.", isCorrect: true },
    { id: "d", text: "A Slack message claiming urgency.", isCorrect: false },
  ],
  explanation: "Trends represent replicable evidence, which is privileged in Socratic inquiry."
};

export function EpistemicWeight({ onComplete }: Props) {
