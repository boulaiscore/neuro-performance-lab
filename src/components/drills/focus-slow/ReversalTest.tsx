...
const DRILL_DATA = {
  ...
  prompt: "Socratic method asks: \"If this detail were reversed, would the situation meaningfully change?\"",
  question: "Only the detail whose reversal changes the problem deserves attention.",
  options: [
    { id: "a", text: "Background color of a dashboard.", isCorrect: false },
    { id: "b", text: "Whether the user goal is well-defined.", isCorrect: true },
    { id: "c", text: "Team mood fluctuations.", isCorrect: false },
    { id: "d", text: "Meeting room assignment.", isCorrect: false },
  ],
  explanation: "Reversing clarity-of-goal completely transforms the decision landscape; nothing else does. This is a Leibnizian sufficiency test applied to attention."
};

export function ReversalTest({ onComplete }: Props) {
