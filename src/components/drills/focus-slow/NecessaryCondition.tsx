...
const DRILL_DATA = {
  title: "The Necessary Condition Test",
  prompt: "Ask: \"Which detail must be true for progress to be possible?\"",
  question: "This is the Socratic identification of a necessary condition.",
  options: [
    { id: "a", text: "Team motivation is high.", isCorrect: false },
    { id: "b", text: "Stakeholders approve the idea.", isCorrect: false },
    { id: "c", text: "Requirements are explicitly known.", isCorrect: true },
    { id: "d", text: "The market reacts positively.", isCorrect: false },
  ],
  explanation: "A necessary condition controls the entire space of possible outcomes → therefore it deserves attention."
};

export function NecessaryCondition({ onComplete }: Props) {
