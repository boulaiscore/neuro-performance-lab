...
const DRILL_DATA = {
  title: "The Contradiction Detector",
  prompt: "Socratic method seeks contradictions first.",
  question: "Which detail deserves attention because it cannot be true simultaneously with the others?",
  options: [
    { id: "a", text: "\"The system is stable.\"", isCorrect: false },
    { id: "b", text: "\"The metrics fluctuate wildly.\"", isCorrect: true },
    { id: "c", text: "\"Users behave predictably.\"", isCorrect: false },
    { id: "d", text: "\"The process has minimal variance.\"", isCorrect: false },
  ],
  explanation: "Wild fluctuation contradicts stability, predictability, and low variance. Attention must go to the element that breaks the coherence."
};

export function ContradictionDetector({ onComplete }: Props) {
