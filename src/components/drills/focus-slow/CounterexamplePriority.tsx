...
const DRILL_DATA = {
  title: "The Counterexample Priority Rule",
  prompt: "Socratic reasoning begins with the strongest counterexample.",
  question: "Which detail deserves attention?",
  options: [
    { id: "a", text: "Evidence that supports your hypothesis.", isCorrect: false },
    { id: "b", text: "A case where your hypothesis fails.", isCorrect: true },
    { id: "c", text: "A narrative that explains your view elegantly.", isCorrect: false },
    { id: "d", text: "A data point that you find aesthetically pleasing.", isCorrect: false },
  ],
  explanation: "Counterexamples reveal logical flaws faster than supportive evidence; attention must go there first."
};

export function CounterexamplePriority({ onComplete }: Props) {
