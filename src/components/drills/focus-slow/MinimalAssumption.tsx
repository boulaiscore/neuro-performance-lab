...
const DRILL_DATA = {
  title: "The Minimal Assumption Rule",
  prompt: "Socratic thinking favors the element requiring the fewest assumptions.",
  question: "Which item deserves attention?",
  options: [
    { id: "a", text: "A stakeholder's emotional interpretation.", isCorrect: false },
    { id: "b", text: "A rumor about hidden risks.", isCorrect: false },
    { id: "c", text: "A directly measurable discrepancy in the data.", isCorrect: true },
    { id: "d", text: "A complex narrative explaining multiple failures.", isCorrect: false },
  ],
  explanation: "Measurable discrepancies import minimal cognitive assumptions and thus deserve focused analysis."
};

export function MinimalAssumption({ onComplete }: Props) {
