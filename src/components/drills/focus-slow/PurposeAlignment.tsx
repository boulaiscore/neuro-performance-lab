...
const DRILL_DATA = {
  title: "The Purpose Alignment Test",
  prompt: "Ask: \"Which detail is directly connected to the purpose of the task?\"",
  question: "The Socratic method begins with telos (purpose).",
  options: [
    { id: "a", text: "A subtask's historical context.", isCorrect: false },
    { id: "b", text: "Personal preferences of team members.", isCorrect: false },
    { id: "c", text: "The success criterion for the task.", isCorrect: true },
    { id: "d", text: "Unrelated industry news.", isCorrect: false },
  ],
  explanation: "The Socratic method begins with telos (purpose): irrelevant details are noise."
};

export function PurposeAlignment({ onComplete }: Props) {
